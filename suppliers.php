...
if (isset($_POST['save_supplier'])) {
    ...
    try {
        ...
        log_activity($id ? 'UPDATE' : 'CREATE', 'suppliers', $log_id, ($id ? 'Updated' : 'Added') . " supplier: $name");
...
if (isset($_GET['delete'])) {
    ...
    try {
        ...
        redirect('suppliers.php', "Cannot delete supplier: " . $e->getMessage(), 'danger');
    }
}
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center" style="gap: 10px;">
                                    ...
                                    <span class="fw-bold"><?php echo $sup['supplier_name']; ?></span>
                                </div>
                            </td>
                            <td class="text-muted"><?php echo $sup['contact_person']; ?></td>
                            <td><i class="fas fa-phone me-1 text-muted" style="font-size: 0.75rem;"></i><?php echo $sup['phone']; ?></td>
                            <td><i class="fas fa-envelope me-1 text-muted" style="font-size: 0.75rem;"></i><?php echo $sup['email']; ?></td>
                            <td class="text-center">
                                <button class="btn btn-sm btn-info edit-sup-btn" data-json='<?php echo json_encode($sup); ?>' data-bs-toggle="modal" data-bs-target="#supplierModal" title="Edit">
                                    <i class="fas fa-pen"></i>
                                </button>
                                <a href="suppliers.php?delete=<?php echo $sup['supplier_id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure?')" title="Delete">
